...
class ofxTCPClientNullTerminated{
	...
	public:
		...
		//the receiver see: STR_END_MSG (ofxTCPClientNullTerminated.h)
...
private:
		...
		ofxTCPClientNullTerminated(const ofxTCPManager & mom){};
		ofxTCPClientNullTerminated & operator=(const ofxTCPClientNullTerminated & mom){return *this;}
		...
		friend class ofxTCPServerNullTerminated;

		ofxTCPManagerNullTerminated	TCPClient;
