...
class ofxTCPManagerNullTerminated
{
public:
	ofxTCPManagerNullTerminated();
	virtual ~ofxTCPManagerNullTerminated() {
	...
	bool Accept(ofxTCPManagerNullTerminated& sock);
...
private:
	...
	ofxTCPManagerNullTerminated(const ofxTCPManagerNullTerminated & mom){};
	ofxTCPManagerNullTerminated & operator=(const ofxTCPManagerNullTerminated & mom){return *this;}
