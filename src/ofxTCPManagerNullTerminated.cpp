...
//--------------------------------------------------------------------------------
bool ofxTCPManagerNullTerminated::m_bWinsockInit= false;

//--------------------------------------------------------------------------------
ofxTCPManagerNullTerminated::ofxTCPManagerNullTerminated()
{
...
bool ofxTCPManagerNullTerminated::Close()
{
...
//--------------------------------------------------------------------------------
void ofxTCPManagerNullTerminated::CleanUp() {
	#ifdef TARGET_WIN32
		WSACleanup();
	#endif
...
//--------------------------------------------------------------------------------
bool ofxTCPManagerNullTerminated::CheckIsConnected(){
#ifdef TARGET_WIN32
	fd_set fd;
	FD_ZERO(&fd);
	FD_SET(m_hSocket, &fd);
...
//--------------------------------------------------------------------------------
bool ofxTCPManagerNullTerminated::Create()
{
...
//--------------------------------------------------------------------------------
bool ofxTCPManagerNullTerminated::Listen(int iMaxConnections)
{
	if (m_hSocket == INVALID_SOCKET) return(false);
...
bool ofxTCPManagerNullTerminated::Bind(unsigned short usPort)
{
...
//--------------------------------------------------------------------------------
bool ofxTCPManagerNullTerminated::Accept(ofxTCPManagerNullTerminated& sConnect)
{
  sockaddr_in addr;
...
//--------------------------------------------------------------------------------
bool ofxTCPManagerNullTerminated::Connect(const char *pAddrStr, unsigned short usPort)
{
...
//--------------------------------------------------------------------------------
int ofxTCPManagerNullTerminated::WaitReceive(time_t timeoutSeconds, time_t timeoutMicros){
...
//--------------------------------------------------------------------------------
int ofxTCPManagerNullTerminated::WaitSend(time_t timeoutSeconds, time_t timeoutMicros){
	if (m_hSocket == INVALID_SOCKET) return SOCKET_ERROR;
...
//--------------------------------------------------------------------------------
bool ofxTCPManagerNullTerminated::SetNonBlocking(bool useNonBlocking)
{
...
bool ofxTCPManagerNullTerminated::IsNonBlocking(){
    return nonBlocking;
}

//--------------------------------------------------------------------------------
int ofxTCPManagerNullTerminated::Write(const char* pBuff, const int iSize)
{
	int iBytesSent= 0;
	int iBytesTemp;
...
int ofxTCPManagerNullTerminated::Send(const char* pBuff, const int iSize)
{
    if (m_hSocket == INVALID_SOCKET) return(SOCKET_ERROR);
...
/// SOCKET_TIMEOUT indicates timeout
/// SOCKET_ERROR in case of a problem.
int ofxTCPManagerNullTerminated::SendAll(const char* pBuff, const int iSize)
{
	if (m_hSocket == INVALID_SOCKET) return(SOCKET_ERROR);
...
/// SOCKET_ERROR in case of a problem.
///
int ofxTCPManagerNullTerminated::Receive(char* pBuff, const int iSize)
{
    if (m_hSocket == INVALID_SOCKET) return(SOCKET_ERROR);
...
/// SOCKET_ERROR in case of a problem.
///
int ofxTCPManagerNullTerminated::PeekReceive(char* pBuff, const int iSize)
{
	if (m_hSocket == INVALID_SOCKET) return(SOCKET_ERROR);
...
/// SOCKET_TIMEOUT indicates timeout
/// SOCKET_ERROR in case of a problem.
int ofxTCPManagerNullTerminated::ReceiveAll(char* pBuff, const int iSize)
{
	if (m_hSocket == INVALID_SOCKET) return(SOCKET_ERROR);
...
//--------------------------------------------------------------------------------
bool ofxTCPManagerNullTerminated::GetRemoteAddr(LPINETADDR pInetAddr)
{
  if (m_hSocket == INVALID_SOCKET) return(false);
...
//--------------------------------------------------------------------------------
bool ofxTCPManagerNullTerminated::GetInetAddr(LPINETADDR pInetAddr)
{
  if (m_hSocket == INVALID_SOCKET) return(false);
...
void ofxTCPManagerNullTerminated::SetTimeoutConnect(int timeoutInSeconds) {
	m_dwTimeoutConnect= timeoutInSeconds;
}
void ofxTCPManagerNullTerminated::SetTimeoutSend(int timeoutInSeconds) {
	m_dwTimeoutSend= timeoutInSeconds;
}
void ofxTCPManagerNullTerminated::SetTimeoutReceive(int timeoutInSeconds) {
	m_dwTimeoutReceive= timeoutInSeconds;
}
void ofxTCPManagerNullTerminated::SetTimeoutAccept(int timeoutInSeconds) {
	m_dwTimeoutAccept= timeoutInSeconds;
}
int ofxTCPManagerNullTerminated::GetTimeoutConnect() {
	return m_dwTimeoutConnect;
}
int ofxTCPManagerNullTerminated::GetTimeoutSend() {
	return m_dwTimeoutSend;
}
int ofxTCPManagerNullTerminated::GetTimeoutReceive() {
	return m_dwTimeoutReceive;
}
int ofxTCPManagerNullTerminated::GetTimeoutAccept() {
	return m_dwTimeoutAccept;
}

int ofxTCPManagerNullTerminated::GetReceiveBufferSize() {
	if (m_hSocket == INVALID_SOCKET) return(false);
...
bool ofxTCPManagerNullTerminated::SetReceiveBufferSize(int sizeInByte) {
	if (m_hSocket == INVALID_SOCKET) return(false);
...
int ofxTCPManagerNullTerminated::GetSendBufferSize() {
	if (m_hSocket == INVALID_SOCKET) return(false);
...
bool ofxTCPManagerNullTerminated::SetSendBufferSize(int sizeInByte) {
	if (m_hSocket == INVALID_SOCKET) return(false);
...
int ofxTCPManagerNullTerminated::GetMaxConnections() {
  return m_iMaxConnections;
}

bool ofxTCPManagerNullTerminated::CheckHost(const char *pAddrStr) {
  hostent * hostEntry;
  in_addr iaHost;
